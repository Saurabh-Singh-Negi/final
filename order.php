...
// $sql="select name from admin where adminid='".$_SESSION["adminid"]."'";
...
<nav class="navbar navbar-dark navbar-top menu">
	...
	<table class="tbl1 table-condensed">
	<tr>
		<th>Sno.</th>
		<th>Order Date</th>
	    <th>Name</th>
    ...
    <?php
	$ctr=1;
	$sql="select * from onlinefooddelivery.order ";
	...
	<tr>
	  ...
	  <td><a href="orderdesc.php?orderid=<?php echo $row["orderid"]; ?>">Details</a></td>
	</tr>
    <?php
     $ctr++;
    }
