...
<nav class="navbar navbar-dark navbar-top menu">
	...
	<div class="col-md-12">
	<button class="btn btn-light"><a href="add_category.php" class="btn pull-left">ADD CATEGORY</a></button>
	</div>
	<tr>
	    <th>Sl No.</th>
		<th>Category Name</th>
	...
	<tr>
	   ...
	   <td><a href="edit_category.php?categoryid=<?php echo $row["categoryid"]; ?>">Edit</a></td>
	   <td><a onclick="del(<?php echo $row["categoryid"]; ?>)">Delete</a></td>
	</tr>
	<?php
	$ctr++;
	}
