...
if(isset($_REQUEST["submit"]))
{
	...
	$sql="update category set categoryname='$categoryname',image='$image' where categoryid='".$_REQUEST["categoryid"]."'";
	}
	else
	{
	$sql="update category set categoryname='$categoryname' where categoryid='".$_REQUEST["categoryid"]."'";
...
$sql="select * from category where categoryid='".$_REQUEST["categoryid"]."'";
$result=mysql_query($sql);
...
<nav class="navbar navbar-dark navbar-top menu">
	  ...
	  <div class="container">
			...
			<form action="" method="post" enctype="multipart/form-data">  
				...
				<div class="col-md-6 space bmr"><input type="text"  class=" form-control" name="categoryname" value="<?php echo $categoryname; ?>" required></div>
				<div class="col-md-6 txtbox">Image :</div>
		        <div class="col-md-6 txtbox"><input type="file" class=" form-control"  name="image" value="<?php echo $image; ?>"></div>
