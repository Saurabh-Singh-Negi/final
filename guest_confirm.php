...
if(isset($_REQUEST["confirm"]))
{
	...
	VALUES
	('$orderdate','$delivery_date','','$name','$email','$mobile_no','$delivery_add','$pincode','$total')";
...
<nav class="navbar navbar-dark navbar-top menu">
	  ...
	  <div class="row">
	  <div class="container">
	        <form method="post" action="guest_confirm.php">
			...
			<div class="col-md-6">
			  <div class="welcomebg col-md-12">
			    <table class="col-md-12 tbl1 table table-condensed">
					<tr>
					<th>Si No.</th>
					<th>Food</th>
					<th>Quantity</th>
