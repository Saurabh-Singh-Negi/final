...
$sql="select username from admin where adminid='".$_SESSION["adminid"]."'";
...
<nav class="navbar navbar-dark navbar-top menu">
	  ...
	  <div class="container">
			<div class="col-md-4">
						...
						<li><a href="orderdesc.php" class="alink form-control">Order Description</a></li><br>
			...
			<div class="col-md-8 welcomebg">
				<p class="welcomebg">Welcome <?php echo $name; ?></p>
			</div>
	</div>
	</div>
	</section>
